...
model_pipeline = Pipeline( steps = [ ('feat_pipeline', pipeline),
...
model_pipeline.predict(['english language development']) # have the transformer create it by passing one name!!
